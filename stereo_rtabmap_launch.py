...
def generate_launch_description():
    return LaunchDescription([
        # ExecuteProcess(
        #     cmd=['ros2', 'bag', 'play', '/home/hortenbach/rosbags/bag_files_AD/ad03'],
        #     output='screen'
        # ),
        # Correct Baseline value for stereo camera pair
        # Node(
        #     package='carla_vo', executable='stereo_syncronizer2', output="screen"
        # ),
        # Stereo Odometry
        Node(
            ...
            parameters=[{
                ...
                "Stereo/WinHeight":"9",                 #3[Window height.]
                "Stereo/WinWidth":"19",                 #15[Window width.]
